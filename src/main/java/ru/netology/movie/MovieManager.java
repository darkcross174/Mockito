...
public class MovieManager {
    ...
    public void add(Movie film) {
        ...
        for ( int i = 0; i < films.length; i++ ) { //создаем цикл, который будет перебирать все элементы по 1, пока они не закончатся в массиве
            tmp[i] = films[i]; // кладем в массив фильмов последний фильм, тем самым увеличивая массив ещё на 1 фильм
        }
